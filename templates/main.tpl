...
.avatar, .avatar_me{width:48px;height:48px;float:left;-webkit-border-radius:5px;background-repeat:no-repeat;-webkit-background-size:48px 48px;}
...
.reply, .delete, .by_who{text-decoration:none;text-align:right;font-size:8pt;color:%s;}
