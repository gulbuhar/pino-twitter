...
.content_old, .content_fresh, .content_me{padding:5px;background-color:rgba(256, 256, 256, 0.3);margin-top:-2px; {{rounded}} border-color:rgba(180, 180, 180, 0.4);border-width:2px;border-style:solid; border-bottom-width:2px;border-right-width:2px;cursor:default;margin-left:60px;}
