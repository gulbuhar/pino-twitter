...
def configure(conf):
	...
	conf.define('MENTIONS_FRESH_PATH', conf.env.PREFIX + '/share/icons/hicolor/scalable/actions/mentions_fresh.svg')
	conf.define('TIMELINE_PATH', conf.env.PREFIX + '/share/icons/hicolor/scalable/actions/timeline.svg')
	conf.define('TIMELINE_FRESH_PATH', conf.env.PREFIX + '/share/icons/hicolor/scalable/actions/timeline_fresh.svg')
	conf.define('DIRECT_PATH', conf.env.PREFIX + '/share/icons/hicolor/scalable/actions/direct.svg')
	conf.define('DIRECT_FRESH_PATH', conf.env.PREFIX + '/share/icons/hicolor/scalable/actions/direct_fresh.svg')
	conf.define('PROGRESS_PATH', conf.env.PREFIX + '/share/icons/hicolor/16x16/animations/progress.gif')
	conf.define('DIRECT_REPLY_PATH', conf.env.PREFIX + '/share/icons/hicolor/16x16/actions/direct_reply.png')
	conf.define('REPLY_PATH', conf.env.PREFIX + '/share/icons/hicolor/16x16/actions/reply.png')
	conf.define('RETWEET_PATH', conf.env.PREFIX + '/share/icons/hicolor/16x16/actions/re_tweet.png')
	conf.define('DELETE_PATH', conf.env.PREFIX + '/share/icons/hicolor/16x16/actions/delete_status.png')
...
def build(bld):
	...
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'img/mentions.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'img/mentions_fresh.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'img/timeline.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'img/timeline_fresh.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'img/direct.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'img/direct_fresh.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/16x16/animations', 'img/progress.gif')
	bld.install_files('${PREFIX}/share/icons/hicolor/16x16/actions', 'img/direct_reply.png')
	bld.install_files('${PREFIX}/share/icons/hicolor/16x16/actions', 'img/reply.png')
	bld.install_files('${PREFIX}/share/icons/hicolor/16x16/actions', 'img/re_tweet.png')
	bld.install_files('${PREFIX}/share/icons/hicolor/16x16/actions', 'img/delete_status.png')
