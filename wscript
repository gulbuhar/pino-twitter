...
def build(bld):
	...
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'mentions_fresh.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'timeline.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'timeline_fresh.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'direct.svg')
	bld.install_files('${PREFIX}/share/icons/hicolor/scalable/actions', 'direct_fresh.svg')
